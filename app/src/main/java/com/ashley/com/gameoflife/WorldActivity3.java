...
public class WorldActivity3 extends Activity implements OnCheckedChangeListener, WorldView3.WorldListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWorldView = (WorldView3) findViewById(R.id.world2);
        mWorldView.setWorldListener(this);
        
        if(savedInstanceState != null && savedInstanceState.containsKey(EXTRA_WORLD)) {
        	World3 world3 = (World3) savedInstanceState.getSerializable(EXTRA_WORLD);
        	mWorldView.setWorld(world3);
        } else {
        	initWorld();
        }
    }
